...
// IMPORTANT: migrate several tables to another db (admins,referrals,promotions)
// IMPORTANT: create a boolean switching system between server and localhost

$active_group = 'localhost'; // DEV: localhost, PROD: production
$active_record = TRUE;
